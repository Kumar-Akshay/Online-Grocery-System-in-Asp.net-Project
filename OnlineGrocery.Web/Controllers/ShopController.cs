...
using OnlineGrocery.Web.Code;
using OnlineGrocery.Web.ViewModels;
...
namespace OnlineGrocery.Web.Controllers
{
    public class ShopController : Controller
    {
        ...
        public ActionResult Index(string searchTerm, int? minimumPrice, int? maximumPrice, int? categoryID, int? sortBy, int? pageNo)
        {
            ...
            int totalCount = ProductsService.Instance.SearchProductsCount(searchTerm, minimumPrice, maximumPrice, categoryID, sortBy, pageNo);
